...
/**
 * copy from {@link AbstractQueuedSynchronizer} AbstractQueuedSynchronizer
 * </br>
 *
 * @author binli sleticalboy@gmail.com
 * created by IDEA 2020/9/27
 */
abstract public class JdkAQS extends AbstractOwnableSynchronizer implements java.io.Serializable {

    private static final long serialVersionUID = 7373984972572414609L;
    ...
    public final boolean tryAcquireSharedNanos(int acquires, long nanosTimeout)
        ...
        return tryAcquireShared(acquires) >= 0 || doAcquireSharedNanos(acquires, nanosTimeout);
    }
    ...
    public class ConditionObject implements Condition, java.io.Serializable {
         ...
         * @return {@code true} if owned
         */
        final boolean isOwnedBy(JdkAQS sync) {
            return sync == JdkAQS.this;
        }

        /**
         * Queries whether any threads are waiting on this condition.
         * Implements {@link JdkAQS#hasWaiters(ConditionObject)}.
         *
         * @return {@code true} if there are any waiting threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *                                      returns {@code false}
         ...
         * this condition.
         * Implements {@link JdkAQS#getWaitQueueLength(ConditionObject)}.
         *
         * @return the estimated number of waiting threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *                                      returns {@code false}
         ...
         * Implements {@link JdkAQS#getWaitingThreads(ConditionObject)}.
         *
         * @return the collection of threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *                                      returns {@code false}
